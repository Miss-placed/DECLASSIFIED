...
function initDonut() {
    document.getElementById("faction-donut").replaceChildren();
    const { factionTotal } = getTotals();
    let { collectedFaction, collectedSeason } = getCollected();
    let factionItems = [{
        label: "Requiem ",
