...
export default function EggsMapPage() {
	...
	const items = useMemo(
		() =>
			gameSlug && mapSlug
				? getOperationsMapItems('sideEgg', gameSlug, mapSlug)
				: [],
		[gameSlug, mapSlug]
	);
	...
	return (
		<Container className="intel-dossier-page link-reset">
			...
			<div className="intel-dossier-actions">
				...
				{gameSlug && mapSlug ? (
					<Link to={`/quests/${gameSlug}/${mapSlug}`}>Open Main Quest Dossier</Link>
				) : null}
