...
const staticIntelStore: IIntelItem[] = [
	...
	/////////////////////Shattered Veil/////////////////////////
	{
		...
		loc: [287.2027230904449, 281.14997866282755],
	...
	},
	{
		...
		season: Season.Season3,
		typeDesc: IntelType.Audio,
		loc: [365.707065128898, 172.4002340375944],
		map: MapIds.shatteredVeil,
	...
	},
	{
		...
		season: Season.Season3,
		typeDesc: IntelType.Audio,
		loc: [395.1581652110171, 385.8603260295814],
		map: MapIds.shatteredVeil,
	...
	},
	{
		...
		season: Season.Season3,
		typeDesc: IntelType.Audio,
		loc: [332.03594304580065, 57.98908888675892],
		map: MapIds.shatteredVeil,
	...
	},
	{
		...
		season: Season.Season3,
		typeDesc: IntelType.Audio,
		loc: [240.84380486787495, 192.505931801941],
		map: MapIds.shatteredVeil,
	...
	},
	{
		...
		season: Season.Season3,
		typeDesc: IntelType.Audio,
		loc: [83.89049344835189, 282.391942734593],
		map: MapIds.shatteredVeil,
	...
	},
	{
		...
		season: Season.Season3,
		typeDesc: IntelType.Audio,
		loc: [330.53908611923515, 369.6620735506469],
		map: MapIds.shatteredVeil,
	...
	},
	{
		...
		season: Season.Season3,
		typeDesc: IntelType.Audio,
		loc: [142.90726818127655, 334.1480198752618],
		map: MapIds.shatteredVeil,
	...
	},
	{
		...
		season: Season.Season3,
		typeDesc: IntelType.Audio,
		loc: [120.21051231848878, 132.04835878361547],
		map: MapIds.shatteredVeil,
	...
	},
	{
		...
		season: Season.Season3,
		typeDesc: IntelType.Audio,
		loc: [377.88438626077027, 433.0205422632314],
		map: MapIds.shatteredVeil,
	...
	},
	{
		...
		season: Season.Season3,
		typeDesc: IntelType.Audio,
		loc: [425.65591849960487, 296.3032732438897],
		map: MapIds.shatteredVeil,
	...
	},
	{
		...
		season: Season.Season3,
		typeDesc: IntelType.Audio,
		loc: [290.69523473256453, 82.62088137674203],
		map: MapIds.shatteredVeil,
	...
	},
	{
		...
		loc: [384.537889935181, 458.4043947217791],
		map: MapIds.shatteredVeil,
	...
	},
	{
		...
		season: Season.Season3,
		typeDesc: IntelType.Docs,
		loc: [80.8096079433217, 85.82776346870997],
		map: MapIds.shatteredVeil,
	...
	},
	{
		...
		season: Season.Season3,
		typeDesc: IntelType.Docs,
		loc: [383.20221884821007, 410.66330428610627],
		map: MapIds.shatteredVeil,
	...
	},
	{
		...
		loc: [362.94807325006457, 314.0092975383236],
		map: MapIds.shatteredVeil,
	...
	},
	{
		...
		season: Season.Season3,
		typeDesc: IntelType.Artifact,
		loc: [398.7535257432351, 313.73626459420575],
		map: MapIds.shatteredVeil,
	...
	},
	{
		...
		season: Season.Season3,
		typeDesc: IntelType.Artifact,
		loc: [278.71698535249874, 89.50074224233816],
		map: MapIds.shatteredVeil,
		title: `Ray Gun Mk.II`,
	...
	},
	{
		...
		season: Season.Season3,
		typeDesc: IntelType.Artifact,
		loc: [356.97768074765236, 431.8588078221496],
		map: MapIds.shatteredVeil,
	...
	},
	{
		...
		season: Season.Season3,
		typeDesc: IntelType.Artifact,
		loc: [312.60596800874356, 289.43796934315645],
		map: MapIds.shatteredVeil,
	...
	},
	{
		...
		season: Season.Season3,
		typeDesc: IntelType.Artifact,
		loc: [322.6171574244101, 61.2827182486806],
		map: MapIds.shatteredVeil,
	...
	/////////////////////The Tomb/////////////////////////
	{
		...
		typeDesc: IntelType.Audio,
		loc: [408.4057030468704, 274.66622333966546],
		map: MapIds.tomb,
		title: `Against A Wall (shoot to kill)`,
		desc: `Stamin Up Room, to the right side before opening door to subterranean caves.`,
		img: `j7nZBCc`,
	},
	{
		id: `BO6S2TAu2`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Audio,
		loc: [297.71604508769485, 267.95255052294846],
		map: MapIds.tomb,
		title: `Making A Monocle (Column C)`,
		desc: `Opposite side of Speed Cola on the left near the stone brazier.`,
		img: `y9vElq9`,
	},
	{
		id: `BO6S2TAu3`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Audio,
		loc: [390.09585094651646, 46.60753042681256],
		map: MapIds.tomb,
		title: `The Infamous Mr Rhodes (To-go box)`,
		desc: `Spawn, directly behind you on a crate.`,
		img: `VvgWrd1`,
	},
	{
		id: `BO6S2TAu4`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Audio,
		loc: [336.4512973261589, 145.1258551364426],
		map: MapIds.tomb,
		title: `Look At All The Bodies (Tile Work)`,
		desc: `Spawn room, to the right of the gateway on a crate.`,
		img: `RdYDsrL`,
	},
	{
		id: `BO6S2TAu5`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Audio,
		loc: [400.0904635982181, 115.95790392841549],
		map: MapIds.tomb,
		title: `Grave Robbers (Miniatures)`,
		desc: `In the Death Perception Room, right side across the Perk machine.`,
		img: `LHqdjuT`,
	},
	{
		id: `BO6S2TAu6`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Audio,
		loc: [367.67956891758786, 331.0475658516408],
		map: MapIds.tomb,
		title: `The Knaves (On a slab)`,
		desc: `Next to the stairs, in the center room, where you are placing the amulet to open gateway.`,
		img: `zbUG5kz`,
	},
	{
		id: `BO6S2TAu7`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Audio,
		loc: [448.04338595298503, 227.49606852501532],
		map: MapIds.tomb,
		title: `Spring Time (Descend)`,
		desc: `Left of Stamin Up.`,
		img: `UmMcAtb`,
	},
	{
		id: `BO6S2TAu8`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Audio,
		loc: [380.9299123226179, 407.0524187917313],
		map: MapIds.tomb,
		title: `Deep Trouble (Ascend)`,
		desc: `Left of Quick Revive close to the ammo crate.`,
		img: `GBRYNyf`,
	},
	{
		id: `BO6S2TAu9`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Audio,
		loc: [343.0168596823203, 86.0961519790252],
		map: MapIds.tomb,
		title: `Retirement Plan (Packed and Ready)`,
		desc: `Spawn on the right of the armour wall buy next to the lamp on some of the crates.`,
		img: `lf8dE48`,
	},
	{
		id: `BO6S2TAu10`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Audio,
		loc: [319.61031392087256, 138.29343691588716],
		map: MapIds.tomb,
		title: `A Fabrication (Dome Light)`,
		desc: `Left in the cave with Deadshot.`,
		img: `kLzfR0l`,
	},
	{
		id: `BO6S2TAu11`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Audio,
		loc: [167.03323226618772, 280.1489153482816],
		map: MapIds.tomb,
		title: `Tortured Artist (Completely Ruined)`,
		desc: `In the DA Nexus, where the ruins are (West of map).`,
		img: `bA8upe8`,
	},
	{
		id: `BO6S2TDo1`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Docs,
		loc: [392.8472234447028, 439.20209539878715],
		map: MapIds.tomb,
		title: `Potts and Pains pt 1 (Stoneware)`,
		desc: `Shoot a pot in between the ammo crate and quick revive in Deep Excavation.`,
		img: `7eK2k7z`,
	},
	{
		id: `BO6S2TDo2`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Docs,
		loc: [346.7356134892547, 290.2176484289068],
		map: MapIds.tomb,
		title: `Potts and Pains pt 2 (Earthenware)`,
		desc: `Shoot a pot above the Red door leading to Nowhere in the Subterranean Temple.`,
		img: `m3RRMsA`,
	},
	{
		id: `BO6S2TDo3`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Docs,
		loc: [461.5246521214195, 260.0880110079597],
		map: MapIds.tomb,
		title: `Potts and Pains pt 3 (Kiln Firing)`,
		desc: `In the shrine of the hierophants, shoot the pots above staminup.`,
		img: `l2cJyyK`,
	},
	{
		id: `BO6S2TDo4`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Docs,
		loc: [287.98272032458135, 283.5881788131348],
		map: MapIds.tomb,
		title: `Potts and Pains pt 4 (Bring back the dead)`,
		desc: `Complete the Skulls EE.`,
		img: `neJmF5o`,
	},
	{
		id: `BO6S2TDo5`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Docs,
		loc: [435.92647775397387, 174.66269138364507],
		map: MapIds.tomb,
		title: `Potts and Pains pt 5 (Precious stones)`,
		desc: `Complete the Gem Stones EE.`,
		img: `tHqeFd5`,
	},
	{
		id: `BO6S2TAr1`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Artifact,
		loc: [340.5866047261408, 319.4742187021812],
		map: MapIds.tomb,
		title: `Aetheric Lantern`,
		desc: `Shoot an Aetheric Lantern anywhere on the map.`,
		img: `TIhP5qI`,
	},
	{
		id: `BO6S2TAr2`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Artifact,
		loc: [257.77213701059713, 447.9512747541589],
		map: MapIds.tomb,
	...
	},
	{
		...
		season: Season.Season2,
		typeDesc: IntelType.Artifact,
		loc: [179.1702775790032, 369.76231632471706],
		map: MapIds.tomb,
		title: `Monolith Crystal Shard`,
		desc: `Progress through the main quest.`,
		img: `gYDuCWy`,
	},
	{
		id: `BO6S2TAr4`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Artifact,
		loc: [189.0077496694932, 355.0191914417711],
		map: MapIds.tomb,
		title: `Ice Staff`,
		desc: `Acquire the Staff of Ice.`,
		img: `lAVTDSV`,
	},
	{
		id: `BO6S2TAr5`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Artifact,
		loc: [131.14987443795414, 355.2544147108327],
		map: MapIds.tomb,
		title: `Sir Archibald's Monocle`,
		desc: `Kill the first Shock Mimic to spawn, usually round 8.`,
		img: `SFjMNpU`,
	},
	{
		id: `BO6S2TAr6`,
		...
		season: Season.Season2,
		typeDesc: IntelType.Artifact,
		loc: [180.02823896677106, 354.6906727575252],
		map: MapIds.tomb,
		title: `Alas, Poor Bernard (An Ice place to rest)`,
		desc: `Skeleton in front of the Ice Staff ritual wall.`,
		img: `xsAxKWQ`,
	},
	/////////////////////Citadelle/////////////////////////
	{
