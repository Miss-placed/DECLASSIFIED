...
export const MiscStore: IMisc = {
	[MapIds.dieMaschine]: [
		...
		new MiscMarker(`sLfEw`, MiscTypes.wallbuy, [220.98347152062405, 256.6785228855506], `Hauer 77`),
		...
		new MiscMarker(`8ZXnY`, MiscTypes.mysteryBox, [253.82439508837203, 263.0384180734296], `The OG`),
	...
	[MapIds.firebaseZ]: [
		...
		new MiscMarker(`7liBz`, MiscTypes.workbench, [158.51146179487426, 291.112396180971], `Used to craft the free RAI K-84.`),
	...
	[MapIds.forsaken]: [
		...
		new MiscMarker(`Cjvh8`, MiscTypes.wallbuy, [85.69720451791603, 91.59201547112765], `XM4`),
		...
		new MiscMarker(`lYdiz`, MiscTypes.power, [253.15739094428088, 302.7173034571824], `Lift the lockdown to unlock PaP.`),
		new MiscMarker(`apJ9z`, MiscTypes.workbench, [382.11455064812753, 258.9058334403415], `Used to construct the Aetherium Neutralizer.`),
	],
	...
	[MapIds.golova]: [
		...
		new MiscMarker(`ZPs7o`, MiscTypes.wallbuy, [285.4329306073199, 141.63750920858075], `DMR 14`),
	...
	[MapIds.libertyFalls]: [
		...
		new MiscMarker(`JtuLa`, MiscTypes.trap, [255.93020667226358, 236.28036037571204], `D.A.G.F\nCost: 1500`),
		new MiscMarker(`Dw9iZ`, MiscTypes.trap, [187.7030591664732, 380.98305147341716], `D.A.G.F\nCost: 1500`),
		...
		new MiscMarker(`H78fX`, MiscTypes.wallArmor, [251.33910903655286, 80.67403768502217], `Level 3 Vest\nCost: 10,000\n(Or 14,000 if lvl 2 vest not acquired)`),
		new MiscMarker(`HlOSF`, MiscTypes.wallArmor, [189.81620216547734, 297.6305458498488], `Level 2 Vest\nCost: 4,000`),
		new MiscMarker(`4qnBp`, MiscTypes.wallArmor, [324.3945658910249, 325.0106960799565], `Level 2 Vest\nCost: 4,000`),
