...
export const PerkStore: MarkerStore = {
	...
	[MapIds.citadelle]: [
		new MiscMarker(``, Perks.deadshot, [171.46832853492387, 152.85308855237312]),
		new MiscMarker(``, Perks.speed, [214.2486937122144, 303.9718379759372]),
		new MiscMarker(``, Perks.meleeMacchiato, [293.3875225716126, 284.21916249124973]),
		new MiscMarker(``, Perks.elemental, [293.94318075830125, 153.0838304327259]),
		new MiscMarker(``, Perks.jugg, [324.64228661377797, 225.70260122669285]),
		new MiscMarker(``, Perks.staminup, [406.76607975552446, 153.4224091921224]),
		new MiscMarker(``, Perks.vulture, [452.7095809502072, 254.33556167620338]),
		new MiscMarker(``, Perks.quick, [371.53318266103963, 421.4483055393233]),
		new MiscMarker(``, Perks.wunderFizz, [152.04365048882423, 175.6295951969671], { uniqueDesc: `Spawns at round 25.` }),
	],
