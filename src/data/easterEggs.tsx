...
export const StaticEggStore: IMisc = {
	...
	[MapIds.libertyFalls]: [
		...
		new MiscMarker(``, EETypes.bonus, [269.5062750742712, 231.81422099725725], `1 of X Aetherella Statues\n Must be collected with Jet Gun, needed for the side easter egg. Up on top of an air conditioning unit.`),
		new MiscMarker(``, EETypes.bonus, [205.28419151815734, 340.36086600016], `1 of X Aetherella Statues\n Must be collected with Jet Gun, needed for the side easter egg.\nOn top of the motel sign, top left.`),
		new MiscMarker(``, EETypes.bonus, [154.626598832603, 254.25667074355712], `1 of X Aetherella Statues\n Must be collected with Jet Gun, needed for the side easter egg.\nUnderneath the bowling sign, jump onto the bus to reach it.`),
		new MiscMarker(``, EETypes.bonus, [313.2844647277621, 313.5398735527481], `1 of X Aetherella Statues\n Must be collected with Jet Gun, needed for the side easter egg.`),
		new MiscMarker(``, EETypes.bonus, [298.67507993856594, 316.96235180755974], `1 of X Aetherella Statues\n Must be collected with Jet Gun, needed for the side easter egg.`),
		new MiscMarker(``, EETypes.bonus, [307.052489398105, 338.26344781138766], `1 of X Aetherella Statues\n Must be collected with Jet Gun, needed for the side easter egg.`),
		new MiscMarker(``, EETypes.bonus, [320.4359118273686, 335.96476838651415], `1 of X Aetherella Statues\n Must be collected with Jet Gun, needed for the side easter egg.`),
		new MiscMarker(`DzJw9`, EETypes.bankVault, [257.1898821141628, 285.095345453075], `Opened by finding 3, 2 digit numbers around the map. After gaining entry player can bring a loot key (dropped by elites) to open any of the 9 lootable deposit boxes.`),
		...
		new MiscMarker(``, EETypes.questCollectible, [238.9828877298804, 252.11651330106537], `1 of 3 L.T.G Parts\nInside a room on the second floor, visible when stood on the white truck. Can only be obtained with the Jet Gun.`),
		new MiscMarker(``, EETypes.questCollectible, [197.3726160604251, 123.97160585884909], `1 of 3 L.T.G Parts\nHovers on the left side of the balcony when looking towards the main door. Can only be obtained with the Jet Gun.`),
		new MiscMarker(``, EETypes.mainQuest, [273.2269499402426, 362.52314672355453], `Aether Storm\nUsed with the L.T.G in the main quest to spawn a HVT.`),
		new MiscMarker(``, EETypes.mainQuest, [244.75569879194023, 125.37056613599053], `Aether Storm\nUsed with the L.T.G in the main quest to spawn a HVT.`),
