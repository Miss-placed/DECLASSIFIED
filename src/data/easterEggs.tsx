...
export const StaticEggStore: MarkerStore = {
	...
	[MapIds.terminusBiolabs]: [
		...
		new MiscMarker(`jRnGe`, markers.megaStuffyCollectible, [196.82120749690176, 157.19676798949905], { linkedItems: `gyHuC`, uniqueTitle: `Duck`, uniqueDesc: `Well hidden inside the corner of the dumpster.`, spoilerTags: `Secret`}),
	...
	[MapIds.shatteredVeil]: [
		...
		new MiscMarker(`H5S9R`, markers.fireSale, [288.71161658427974, 354.9378194889196], { uniqueDesc: `Only appears after shooting all 7 other power ups. Hidden inside the chandelier.` , spoilerTags: `Secret`}),
