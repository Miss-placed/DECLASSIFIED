...
export const StaticEggStore: IMisc = {
	...
	[MapIds.libertyFalls]: [
		...
		new MiscMarker(`0OHjM`, EETypes.bonus, [154.626598832603, 254.25667074355712], `1 of 9 Aetherella Statues\n Must be collected with Jet Gun.\nNext to the bowling sign, jump onto the bus to reach it.`),
		new MiscMarker(`G4IGc`, EETypes.bonus, [313.2844647277621, 313.5398735527481], `1 of 9 Aetherella Statues\n Must be collected with Jet Gun.`),
		new MiscMarker(`4w4zQ`, EETypes.bonus, [298.67507993856594, 316.96235180755974], `1 of 9 Aetherella Statues\n Must be collected with Jet Gun.`),
		new MiscMarker(`ypSrs`, EETypes.bonus, [307.052489398105, 338.26344781138766], `1 of 9 Aetherella Statues\n Must be collected with Jet Gun.`),
		...
		new MiscMarker(`bw8QU`, EETypes.mrPeeksCollectible, [163.66353585351, 283.1703256475334], `Bonus Bowling Shoe\nSpawns a couple of rounds after bowling, can be shot to play bowling again!`),
		...
		new MiscMarker(`Wa3zX`, EETypes.clue, [243.625, 293.28125], `1 of 3 numbers needed for the bank vault.`),
		...
		new MiscMarker(`nrdC1`, EETypes.secretArea, [315.93382666269605, 361.87607283382033], `Radio House\nDoors can be shot open with a mangler canon, either by the player crafting one and shooting it, or getting shot by a mangler by accident.`),
		new MiscMarker(`6kxsh`, EETypes.secretArea, [287.28585675673804, 165.51984877300072], `Groundskeepers Shed\nContains the Handbrake for the Jet Gun quest. Can only be opened by using the shed key. You can find the groundskeeper zombie in the cemetary, kill him before he teleports away, dropping his key.`),
		new MiscMarker(`dmzoe`, EETypes.questCollectible, [319.65450152866737, 375.7881614631044], `Wires\nUsed in the Jet Gun quest.\nInteract with the black piles of electrical rubbish in order to find wires from one of them.`),
		new MiscMarker(`fv8Dz`, EETypes.questCollectible, [290.29374516958853, 167.1612637421355], `Handbrake\nUsed in the Jet Gun quest.\nLocked inside the groundskeeper's shed.`),
		new MiscMarker(`4vmr0`, EETypes.questCollectible, [128.12063016736064, 253.00589088605057], `Pressure Gauge\nUsed in the Jet Gun quest.\nLocked behind a panel that can be shot open, then it can be obtained by overpressuring it using a tap.`),
		new MiscMarker(`7RCQd`, EETypes.mainQuest, [209.9971117591179, 111.23062643890167], `S.D.G\nA device that uses charged aetherium canisters to close the dark aether. Players must charge 2 canisters and return them here to begin the boss battle.`),
		new MiscMarker(`SvGXG`, EETypes.questCollectible, [309.71024070860136, 323.1210254565541], `1 of 3 L.T.G Parts\nStuck in the roof, can only be obtained with the Jet Gun.`),
		new MiscMarker(`O1Xh5`, EETypes.questCollectible, [238.9828877298804, 252.11651330106537], `1 of 3 L.T.G Parts\nInside a room on the second floor, visible when stood on the white truck. Can only be obtained with the Jet Gun.`),
		new MiscMarker(`fyjJz`, EETypes.questCollectible, [197.3726160604251, 123.97160585884909], `1 of 3 L.T.G Parts\nHovers on the left side of the balcony when looking towards the main door. Can only be obtained with the Jet Gun.`),
		new MiscMarker(`33Wyd`, EETypes.mainQuest, [273.2269499402426, 362.52314672355453], `Aether Storm\nUsed with the L.T.G in the main quest to spawn a HVT.`),
		new MiscMarker(`VGizY`, EETypes.mainQuest, [244.75569879194023, 125.37056613599053], `Aether Storm\nUsed with the L.T.G in the main quest to spawn a HVT.`),
		new MiscMarker(`mrMRU`, EETypes.questCollectible, [157.61254240360353, 214.89424677771137], `1 of 3 Scopes used in the main quest to open the next aetherium canister. Use the equipment provided by the S.D.G to set the scope light to the correct colour for each scope.`),
		new MiscMarker(`9uYMI`, EETypes.questCollectible, [283.47680491477615, 218.01350931794695], `1 of 3 Scopes used in the main quest to open the next aetherium canister. Use the equipment provided by the S.D.G to set the scope light to the correct colour for each scope.`),
		new MiscMarker(`SkNCT`, EETypes.questCollectible, [233.46875, 328.78125], `1 of 3 Scopes used in the main quest to open the next aetherium canister. Use the equipment provided by the S.D.G to set the scope light to the correct colour for each scope.`),
		new MiscMarker(`xG8zU`, EETypes.mainQuest, [219.50905939855957, 413.9982260079434], `Uncharged Aetherium Canister\nUsed in the main quest after charging the first canister. Must be retrived and charged in the same way as the first canister using the L.T.G, HVT and a D.A.G.F trap.`),
		new MiscMarker(`ycopO`, EETypes.clue, [297.32875445409906, 383.9627368184202], `Set of binoculars that can be used for 50 essence. A dancing zombie can be spotted on a rock. The zombies will not attack you whilst in use. When both binoculars are focused on the dancing zombie, a party will start!`),
		new MiscMarker(`Xvkv1`, EETypes.clue, [282.07221275373934, 388.5203872504264], `Set of binoculars that can be used for 50 essence. A dancing zombie can be spotted on a rock. The zombies will not attack you whilst in use. When both binoculars are focused on the dancing zombie, a party will start!`),
		new MiscMarker(`9DjTf`, EETypes.bonus, [196.2236235990396, 77.3084034954576], `Unlit Candles\n 1 of 2 candle racks that can be shot with Napalm burst to trigger a fire trap inside the main church building. Useful for the final battle.`),
		new MiscMarker(`jgS2I`, EETypes.bonus, [218.4032735692863, 81.15692723458717], `Unlit Candles\n 1 of 2 candle racks that can be shot with Napalm burst to trigger a fire trap inside the main church building. Useful for the final battle.`),
	]
};