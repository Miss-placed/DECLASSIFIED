...
export const StaticEggStore: IMisc = {
	...
	[MapIds.ruka]: [
		...
		new MiscMarker(`2GHxO`, EETypes.mainQuest, [137.72609960588565, 209.4762648508773], `Silo D\nApproximate Location\m Contains the jellyfish that holds a key, only accessible whilst using the charged aetherium canister from Silo B, remember to grab the key whilst being dragged through the jellyfish. Also has a launch control board, the green lights indicate the order of activation after acquiring the keys.`),
