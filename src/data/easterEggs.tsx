...
export const StaticEggStore: MarkerStore = {
	...
	[MapIds.terminusBiolabs]: [
		new MiscMarker(`24MSZ`, markers.culinaryDelightIngredient, [293.65625, 253.4375], { linkedItem: `N_OVB`, uniqueTitle: `Brain`, uniqueDesc: `On a scale.` }),
		...
		new MiscMarker(`aFker`, markers.freePerk, [322.50688078091434, 253.46419422564134], { uniqueDesc: `Prison Cages\nShoot all of the zombies in the cages to progress this egg. Come back each round and kill the next set of enemies in the cages. Do this for a total of 3 rounds in order to get a Random Perk powerup.` }),
		new MiscMarker(`e2wmE`, markers.sporesEgg, [245.29420895882905, 246.69189675916428]),
		new MiscMarker(`K1Qqi`, markers.sporesEggIsland, [320.37235194976347, 369.51501360577436], { linkedItem: `e2wmE` }),
		new MiscMarker(`Wwi1L`, markers.sporesEggIsland, [181.70559599805756, 292.15948970467394], { linkedItem: `e2wmE` }),
		new MiscMarker(`IrCcu`, markers.sporesEggIsland, [394.71637855757484, 331.71296617807366], { linkedItem: `e2wmE` }),
		new MiscMarker(`rVsH3`, markers.sporesEggIsland, [280.65565928903317, 202.6034936879411], { linkedItem: `e2wmE` }),
		new MiscMarker(`zp3ym`, markers.megaStuffyCollectible, [252.61507336172045, 307.0092031071911], { linkedItem: `gyHuC`, uniqueTitle: `Elephant` }),
		new MiscMarker(`jRnGe`, markers.megaStuffyCollectible, [196.82120749690176, 157.19676798949905], { linkedItem: `gyHuC`, uniqueTitle: `Duck`, uniqueDesc: `Well hidden inside the corner of the dumpster.`, }),
		new MiscMarker(`XjZgQ`, markers.megaStuffyCollectible, [124.32855827930155, 213.8187024856514], { linkedItem: `gyHuC`, uniqueTitle: `Giraffe`, uniqueDesc: `Behind the light on the right side.` }),
		new MiscMarker(`523nW`, markers.megaStuffyCollectible, [290.40625, 298.9375], { linkedItem: `gyHuC`, uniqueTitle: `Bear`, uniqueDesc: `Near the arsenal, on a medical table near the floor.` }),
		...
		new MiscMarker(`BP6Xq`, markers.cursedTreasureHunt, [276.04996791307724, 234.638024611905], { linkedItem: `BO6S0TAr5` }),
		new MiscMarker(`3Ig9c`, markers.cursedTreasureHuntSkeleton, [383.0625, 191.78125], { linkedItem: `BP6Xq` }),
		new MiscMarker(`ZlkGz`, markers.cursedTreasureHuntSkeleton, [274.3935309560461, 425.7227774089735], { linkedItem: `BP6Xq` }),
		new MiscMarker(`nTqHJ`, markers.cursedTreasureHuntSkeleton, [189.625, 150.25], { linkedItem: `BP6Xq` }),
	...
	[MapIds.terminusPrison]: [
		...
		new MiscMarker(`lZCQo`, markers.culinaryDelightIngredient, [256.96875, 249.5625], { linkedItem: `N_OVB`, uniqueTitle: `Beans`, uniqueDesc: `Between two crates.` }),
		new MiscMarker(`zQvyy`, markers.culinaryDelightIngredient, [246.13847407960418, 302.7807642719513], { linkedItem: `N_OVB`, uniqueTitle: `Battery`, uniqueDesc: `On the desk in the middle of the room.` }),
		new MiscMarker(`Ygw12`, markers.culinaryDelightIngredient, [278.7177567942043, 255.77817285834016], { linkedItem: `N_OVB`, uniqueTitle: `Mushroom`, uniqueDesc: `By the right of the stairs when looking up.` }),
		new MiscMarker(`kL_5g`, markers.culinaryDelightIngredient, [257.6907948564727, 271.995229023223], { linkedItem: `N_OVB`, uniqueTitle: `Snowball`, uniqueDesc: `On top of the fridge.` }),
		new MiscMarker(`0cv_q`, markers.megaStuffyCollectible, [295.40625, 304.625], { linkedItem: `gyHuC`, uniqueTitle: `Unicorn`, uniqueDesc: `In a slightly open locker in the corner of the armoury room.` }),
		new MiscMarker(`gmj3c`, markers.megaStuffyCollectible, [237.59375, 298.8125], { linkedItem: `gyHuC`, uniqueTitle: `Monkey`, uniqueDesc: `Outside the caged walkway in the corner by the brick wall.` }),
		new MiscMarker(`PvId2`, markers.meteorTower, [248.07976653247508, 308.22281601773426], { linkedItem: `3ZEt8`, uniqueDesc: `Visible from the stairs south of spawn, either side.` }),
		new MiscMarker(`sesSc`, markers.meteorTower, [313.01988207230005, 260.52399603518677], { linkedItem: `3ZEt8`, uniqueDesc: `Visible from the stairs south of spawn, either side.` }),
