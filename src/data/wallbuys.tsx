...
export const WallbuyStore: MarkerStore = {
	...
	[MapIds.mauerDerTotenStreets]: [
		...
		new MiscMarker(`a58Jw`, MiscTypes.wallbuy, [185.58532320815584, 84.36475727370681], { uniqueTitle: `Pelington 703` }),
	],
	[MapIds.forsaken]: [
	...
	[MapIds.shatteredVeil]: [
		new MiscMarker(`uOZLR`, MiscTypes.wallbuy, [114.43029192857867, 146.0703948858506], { uniqueTitle: `GS45` }),
		new MiscMarker(`DYGgH`, MiscTypes.wallbuy, [85.49704358574752, 229.69354993185902], { uniqueTitle: `Kompakt 92` }),
		new MiscMarker(`4h3t8`, MiscTypes.wallbuy, [234.58913626357796, 214.03712827205692], { uniqueTitle: `Tanto .22` }),
		new MiscMarker(`8C4KZ`, MiscTypes.wallbuy, [180.70954774526606, 368.26976482103913], { uniqueTitle: `Marine-SP` }),
		new MiscMarker(`F6LnQ`, MiscTypes.wallbuy, [297.68968570811126, 404.3073866239473], { uniqueTitle: `AK-74` }),
		new MiscMarker(`CwkVd`, MiscTypes.wallbuy, [399.99351009709795, 464.70186703311737], { uniqueTitle: `Swat 5.56` }),
		new MiscMarker(`f8F6l`, MiscTypes.wallbuy, [312.02868122625523, 356.28303343657734], { uniqueTitle: `AMES 85` }),
