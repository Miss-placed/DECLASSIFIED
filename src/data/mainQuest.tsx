...
export const StaticQuestStore: MarkerStore = {
	...
	[MapIds.citadelle]: [
		...
		new MiscMarker(`6UGOZ`, markers.mainQuest, [408.3883401637771, 253.4254505708876], { linkedItems: `rt2J9,i5G3V,Rx6v2,JKqce`, uniqueTitle: `Mystic Orb`, uniqueDesc: `Is required to open the Secret Study. To spawn it, in the order as noted on the Secret Study Door (Clockwise from the top), perform a weapon inspect with the matching sword in front of the matching statue, then activate the appropriate incantation on the same statue. When done correctly the statue will light up yellow. After the 4th statue is done the Orb will spawn.` },),
