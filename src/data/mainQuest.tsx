...
export const StaticQuestStore: MarkerStore = {
	...
	/////////////////////Bo6 Items/////////////////////////
	[MapIds.libertyFalls]: [
		new MiscMarker(`GCP5X`, markers.mainQuest, [192.74919588520245, 336.28228145349664], { uniqueTitle: `Jet Gun Room`, uniqueDesc: `A room that will burst open with zombies when approached. Contains a workbench and hints on how to build the Wonder Weapon.` }),
		...
		new MiscMarker(`dmzoe`, markers.questCollectible, [319.65450152866737, 375.7881614631044], { uniqueTitle: `Wires`, uniqueDesc: `Used in the Jet Gun quest.\nInteract with the black piles of electrical rubbish in order to find wires from one of them.` }),
		new MiscMarker(`fv8Dz`, markers.questCollectible, [290.29374516958853, 167.1612637421355], { uniqueTitle: `Handbrake`, uniqueDesc: `Used in the Jet Gun quest.\nLocked inside the groundskeeper's shed.` }),
		new MiscMarker(`4vmr0`, markers.questCollectible, [128.12063016736064, 253.00589088605057], { uniqueTitle: `Pressure Gauge`, uniqueDesc: `Used in the Jet Gun quest.\nLocked behind a panel that can be shot open, then it can be obtained by overpressuring it using a tap.` }),
