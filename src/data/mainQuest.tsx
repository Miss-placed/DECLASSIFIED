...
const markers = {
	...
	bastardSword: new Item({
		title: `Bastard Sword`, desc: `Used as part of the main quest to unlock the incantations and the mystical orb.`, icon: IconFileNames.mainQuest,
	}),
	bastardSwordUpgrade: new Item({
		title: `Bastard Sword Upgrade`, desc: `Upgrades the bastard sword to it's elemental variant.`, icon: IconFileNames.mainQuest,
	}),
	...
	ritualStep: new Item({
		title: `Ritual Step`, icon: IconFileNames.mainQuest,
	}),
};
...
export const StaticQuestStore: MarkerStore = {
	...
	[MapIds.terminusBiolabs]: [
		...
		new MiscMarker(``, markers.questCollectible, [295.375, 292.75], { linkedItems: `BO6S0TAr2,hDBzb`, uniqueTitle: `Keycard`, uniqueDesc: `Found in the water after defeating Nathan. Used to open the secret door underneath the cargo ship.` }),
		new MiscMarker(``, markers.secretArea, [226.6600102503698, 131.84035663886576], { linkedItems: ``, uniqueTitle: `Node Connector Lockdown Room`, uniqueDesc: `Only accessible after obtaining the keycard. Climb the ladder to get inside. Must remain in this room and defeat zombies until the lockdown ends. Lockdown starts when you pick up a Node Connector.` }),
		new MiscMarker(``, markers.questCollectible, [223.42015876022728, 124.8854754400265], { linkedItems: ``, uniqueTitle: `Node Connector`, uniqueDesc: `1 of 2\nFound inside the cargo ship. Must be taken to the 2 empty sections of the 3 total Node Connector points.` }),
		new MiscMarker(``, markers.mainQuest, [136.10428195026734, 204.40524245364648], { linkedItems: ``, uniqueTitle: `Node Connector Section`, uniqueDesc: `1 of 3\nIf empty will need to be repaired with 1 of the 2 Node Connectors.` }),
		new MiscMarker(``, markers.mainQuest, [212.58314921057286, 306.68622849204047], { linkedItems: ``, uniqueTitle: `Node Connector Section`, uniqueDesc: `1 of 3\nIf empty will need to be repaired with 1 of the 2 Node Connectors.` }),
		new MiscMarker(``, markers.mainQuest, [260.1956545572801, 256.72058738456184], { linkedItems: ``, uniqueTitle: `Node Connector Section`, uniqueDesc: `1 of 3\nIf empty will need to be repaired with 1 of the 2 Node Connectors.` }),
		new MiscMarker(``, markers.mainQuest, [153.15786916316517, 174.7691022352682], { linkedItems: ``, uniqueTitle: `Hacking Buoy`, uniqueDesc: `1 of 3\nCan be hacked after obtaining the Hacking Device from Peck and Strauss. Must be done under a timer and will spawn parasites.` }),
		new MiscMarker(``, markers.mainQuest, [396.16910225823494, 257.21374134292336], { linkedItems: ``, uniqueTitle: `Hacking Buoy`, uniqueDesc: `1 of 3\nCan be hacked after obtaining the Hacking Device from Peck and Strauss. Must be done under a timer and will spawn parasites.` }),
		new MiscMarker(``, markers.mainQuest, [194.92670670317787, 372.92429495818897], { linkedItems: ``, uniqueTitle: `Hacking Buoy`, uniqueDesc: `1 of 3\nCan be hacked after obtaining the Hacking Device from Peck and Strauss. Must be done under a timer and will spawn parasites.` }),
		new MiscMarker(``, markers.mainQuest, [313.2611643581533, 249.5642753732451], { linkedItems: ``, uniqueTitle: `Bomb Defusal`, uniqueDesc: `1 of 3\nMust be defused directly after the hacking step. You will be timed, use distractions or field upgrades to buy time and defuse. The progress does not reset so keep going until all 3 are done.` }),
		new MiscMarker(``, markers.mainQuest, [313.53603670117946, 303.7654809356315], { linkedItems: ``, uniqueTitle: `Bomb Defusal`, uniqueDesc: `1 of 3\nMust be defused directly after the hacking step. You will be timed, use distractions or field upgrades to buy time and defuse. The progress does not reset so keep going until all 3 are done.` }),
		new MiscMarker(``, markers.mainQuest, [328.84375, 277.03125], { linkedItems: ``, uniqueTitle: `Bomb Defusal`, uniqueDesc: `1 of 3\nMust be defused directly after the hacking step. You will be timed, use distractions or field upgrades to buy time and defuse. The progress does not reset so keep going until all 3 are done.` }),
	],
	[MapIds.terminusPrison]: [
		...
		new MiscMarker(`da69a`, markers.questCollectible, DefaultPOIData.nullLoc, { linkedItems: ``, uniqueTitle: `Hard Drive`, uniqueDesc: `Can be found in any of 4 locations. The one you want is already smashed and has blood and a badge below it. Use the Beamsmasher's primary fire on the trap whilst active. Required to progress the main quest and find Nathan.` }),
		new MiscMarker(``, markers.mainQuest, [303.9692806052967, 277.8106048830418], { linkedItems: ``, uniqueTitle: `Peck & Strauss`, uniqueDesc: `Can be interacted with to complete the code for the resonator for 5000 essence.\nMust also be interacted with in order to find Nathan after obtaining the Hard Drive.\nFinally, they will provide the Hacking Device after completing the rewiring step.` }),
		new MiscMarker(``, markers.clue, [284.6924857528651, 260.8233832401894], { linkedItems: ``, uniqueTitle: `Cell Code #1 - Clock`, uniqueDesc: `The hour hand of the clock.\nA clue for one of the numbers in the 3 digit code for Nathan's cell.` }),
		new MiscMarker(``, markers.clue, [245.1875, 250.1875], { linkedItems: ``, uniqueTitle: `Cell Code #2 - Playing Card`, uniqueDesc: `The number on the playing card.\nA clue for one of the numbers in the 3 digit code for Nathan's cell.` }),
		new MiscMarker(``, markers.clue, [251.87483340617834, 305.9176019845688], { linkedItems: ``, uniqueTitle: `Cell Code #3 - Injury Sign`, uniqueDesc: `The number of days since last injury sign\n.A clue for one of the numbers in the 3 digit code for Nathan's cell.` }),
	],
	[MapIds.citadelle]: [
		...
		new MiscMarker(`TB1Ey`, markers.questCollectible, [379.5781514302129, 414.1441537743096], { uniqueTitle: `Torn Paper #1`, uniqueDesc: `This page tells you the first Point of Power trap that needs to be completed, make a note of it if you'd like to avoid the wall step. Can be found around the hallway area.` }),
		new MiscMarker(`lgO4Q`, markers.questCollectible, [379.5781514302129, 414.1441537743096], { uniqueTitle: `Torn Paper #2`, uniqueDesc: `This page tells you the second Point of Power trap that needs to be completed, make a note of it if you'd like to avoid the wall step. Can be found around the beds area.` }),
		new MiscMarker(`SLY7x`, markers.questCollectible, [379.5781514302129, 414.1441537743096], { uniqueTitle: `Torn Paper #3`, uniqueDesc: `This page tells you the third Point of Power trap that needs to be completed, make a note of it if you'd like to avoid the wall step. Can be found around the sofa and TV area.` }),
		new MiscMarker(`ELKta`, markers.questCollectible, [379.5781514302129, 414.1441537743096], { uniqueTitle: `Torn Paper #4`, uniqueDesc: `This page tells you the final Point of Power trap that needs to be completed, make a note of it if you'd like to avoid the wall step. Can be found around the hallway area by the alchemical lab.` }),
		...
		new MiscMarker(`42s5g`, markers.bastardSword, [413.3523471673312, 241.10285219882513], { uniqueTitle: `The Raven`, uniqueDesc: `To upgrade you will need to find a statue in the Alchemical Lab with an animal part. Then head to the pub basement.`, linkedItems: `4cszs`, }),
		...
		new MiscMarker(`2ksQs`, markers.bastardSwordUpgradeCollectible, [414.92783786723436, 210.1867410559687], { uniqueTitle: `Antiquity`, uniqueDesc: `Used for the Raven Sword upgrade.\nFound in the Alchemical Lab on any of the shelves around the room. Will be random and one of several variants. Once obtained, must be placed in the circular puzzle in the pub to activate it.`, linkedItems: `4cszs`, }),
		...
		new MiscMarker(`cC4KM`, markers.ritualCollectible, [431.81941352000524, 222.23781206063748], { uniqueTitle: `Ritual Item - The Lion`, uniqueDesc: `Paladin's Brooch\nObtained by shooting each red crystal light along the walls, starting with the one above the fireplace in the dining room. Aim the light beam at the next one, by shooting it from the left or right side of each crystal.`, linkedItems: ``, }),
		new MiscMarker(`1kPgF`, markers.ritualCollectible, DefaultPOIData.nullLoc, { uniqueTitle: `Ritual Item - The Dragon`, uniqueDesc: `Ankh Charm\nYou must ignite 3 wood bundles and kill a Doppleghast to drop this item. It has no fixed location.`, linkedItems: `bdRP2,ZT7wi,Jw3mF`, }),
		new MiscMarker(`bdRP2`, markers.ritualStep, [272.91008968927326, 157.77883305787276], { uniqueTitle: `Ritual Item Step - The Dragon`, uniqueDesc: `Wood Bundle\nNeeds to be ignited using any source of fire e.g. molotov, fire sword, incendiary. Once all 3 are lit, a Doppleghast will spawn, kill it to obtain the Ankh Charm`, linkedItems: `KINbg`, }),
		...
		new MiscMarker(`UV7WP`, markers.pointOfPower, [323.55385236404203, 376.13837088011826]),
		new MiscMarker(`RSzpo`, markers.pointOfPower, [354.7299089317141, 444.3757334270622]),
		new MiscMarker(`QPh5Z`, markers.pointOfPower, [398.0672220860039, 170.86692346643366]),
		new MiscMarker(`BwIRp`, markers.pointOfPower, [249.81997914264485, 219.42950745312723]),
		new MiscMarker(`q48DR`, markers.pointOfPower, [192.49981801841787, 132.5426584987053]),
		new MiscMarker(`BhTte`, markers.pointOfPower, [156.40214500790114, 294.00889124478766]),
	]
};