...
const markers = {
	...
	//Forsaken specific
	aetherCrystal: new Item({
		title: `Aether Crystal`, icon: IconFileNames.crystal,
	}),
	// Outbreak specific
	...
	blueCrystal: new Item({
		title: 'Blue Crystal', icon: IconFileNames.crystalBlue,
	...
	ritualChalice: new Item({
		title: 'Ritual Chalice', icon: IconFileNames.interactable,
...
export const StaticQuestStore: MarkerStore = {
	[MapIds.dieMaschine]: [
		...
		new MiscMarker(`3eput`, markers.questCollectible, [314.69833497058926, 344.089550203993], { uniqueTitle: `Fuse Box`, uniqueDesc: `Used in the Thermophasic upgrade steps, hidden under the plane nose, inaccessible unless in the Dark Aether.` , spoilerTags: `Secret`}),
	...
	[MapIds.dieMaschineUnderground]: [
		new MiscMarker(`UTXXu`, markers.secretArea, [293.1716173546175, 370.9160154554998], { uniqueDesc: `Only accessible after using the Aether Tunnel above ground. 1 of 2 places the PaP part can spawn.` , spoilerTags: `Secret`}),
		new MiscMarker(`6WnTv`, markers.secretArea, [206.2697306892794, 176.17280788708192], { uniqueDesc: `Only accessible after using the Aether Tunnel above ground. 1 of 2 places the PaP part can spawn.` , spoilerTags: `Secret`}),
		...
		new MiscMarker(`rRnc1`, markers.bossFight, [188.234154595668, 343.69573623599854], { uniqueTitle: `Defend Orlov`, uniqueDesc: `Once you pick up the family photo you are teleported into the particle accelerator room and must defend Orlov whilst he shuts down the station.`, linkedItems: `TbPJZ` , spoilerTags: `Boss Fight`}),
	],
	...
	[MapIds.mauerDerToten]: [
		...
		new MiscMarker(`CWAYy`, markers.secretArea, [310.84582665268846, 317.22578660679153], { uniqueTitle: `Train Carriage`, uniqueDesc: `Use Klaus to stop the train, contains the Keycard and Warhead needed for the main quest.` , spoilerTags: `Secret`}),
		new MiscMarker(`4QpYx`, markers.secretArea, [168.43591618416733, 160.56583724877993], { uniqueTitle: `Valentina's Lab`, uniqueDesc: `Klaus can knock the wall down. Then use the CRBR-S beam mod to open the metal door.` , spoilerTags: `Secret`}),
	...
	[MapIds.mauerDerTotenStreets]: [
		...
		new MiscMarker(`0ZFbr`, markers.secretArea, [118.31471157271051, 467.80515920170296], { uniqueTitle: `Hotel Room 305 & Klaus Part`, uniqueDesc: `Use a brain rot zombie to open door and get Klaus hands and the safe for CRBR-S.` , spoilerTags: `Secret`}),
	...
	[MapIds.forsaken]: [
		...
		new MiscMarker(`ldDz3`, markers.aetherCrystal, [271.9707732304297, 91.92974890168614], { uniqueTitle: `Large Dark Aether Crystal #2`, uniqueDesc: `Spawns 3 floating orbs that must be shot before the main crystal can be destroyed with the Crysalax Savager.\nThis will drop a Crystal Shard. These must be thrown in the mouth of an abomination, turning it's tail orange. Then it must be killed to obtain a Catalyzed Crystal Shard. Do this for all 3 crystals around the map.` }),
		new MiscMarker(`MUexS`, markers.aetherCrystal, [350.61973067962373, 191.0702416911157], { uniqueTitle: `Large Dark Aether Crystal #3`, uniqueDesc: `Spawns 3 floating orbs that must be shot before the main crystal can be destroyed with the Crysalax Savager.\nThis will drop a Crystal Shard. These must be thrown in the mouth of an abomination, turning it's tail orange. Then it must be killed to obtain a Catalyzed Crystal Shard. Do this for all 3 crystals around the map.` }),
	...
	[MapIds.forsakenUnderground]: [
		...
		new MiscMarker(`mVIvK`, markers.aetherCrystal, [296.373367239989, 339.2622775270375], { uniqueTitle: `Large Dark Aether Crystal #1`, uniqueDesc: `Spawns 3 floating orbs that must be shot before the main crystal can be destroyed with the Crysalax Savager.\nThis will drop a Crystal Shard. These must be thrown in the mouth of an abomination, turning it's tail orange. Then it must be killed to obtain a Catalyzed Crystal Shard. Do this for all 3 crystals around the map.` }),
	],
	/////////////////////Outbreak Items/////////////////////////
	[MapIds.zoo]: [
	...
	[MapIds.ruka]: [
		...
		new MiscMarker(`H953x`, markers.secretArea, [166.0827125211619, 188.495466417831], { uniqueDesc: `Elevator to the underground silo as part of the first main outbreak quest. Unlocks after completing the monkey microfilm and projector step and teleporting to Ruka on or after round 5.` , spoilerTags: `Secret`}),
	...
	[MapIds.sanatorium]: [
		...
		new MiscMarker(`_dw2s`, markers.secretArea, [299.70855299802906, 351.714669003909], { uniqueDesc: `Orda boss fight location, the rebuilt rover is required in order to pass through the barrier.` , spoilerTags: `Secret`}),
	],
	[MapIds.collateral]: [
	...
	[MapIds.libertyFalls]: [
		...
		new MiscMarker(`nrdC1`, markers.secretArea, [315.93382666269605, 361.87607283382033], { uniqueTitle: `Radio House`, uniqueDesc: `Doors can be shot open with a mangler canon, either by the player crafting one and shooting it, or getting shot by a mangler by accident.` , spoilerTags: `Secret`}),
		new MiscMarker(`6kxsh`, markers.secretArea, [287.28585675673804, 165.51984877300072], { uniqueTitle: `Groundskeepers Shed`, uniqueDesc: `Contains the Handbrake for the Jet Gun quest. Can only be opened by using the shed key. You can find the groundskeeper zombie in the cemetery, kill him before he teleports away, dropping his key.` , spoilerTags: `Secret`}),
	...
	[MapIds.terminusBiolabs]: [
		...
		new MiscMarker(`CPqC_`, markers.questCollectible, [295.375, 292.75], { linkedItems: `hDBzb`, linkedIntelIds: `BO6S0TAr2`, uniqueTitle: `Keycard`, uniqueDesc: `Found in the water after defeating Nathan. Used to open the secret door underneath the cargo ship.` , spoilerTags: `Secret`}),
		new MiscMarker(`vKqWW`, markers.secretArea, [226.6600102503698, 131.84035663886576], { linkedItems: `CPqC_`, uniqueTitle: `Node Connector Lockdown Room`, uniqueDesc: `Only accessible after obtaining the keycard. Climb the ladder to get inside. Must remain in this room and defeat zombies until the lockdown ends. Lockdown starts when you pick up a Node Connector.` , spoilerTags: `Secret`}),
	...
	[MapIds.terminusPrison]: [
		new MiscMarker(`Ou1IZ`, markers.secretArea, [253.5625, 273.53125], { uniqueTitle: `Aanya Tonovsky's Lab`, uniqueDesc: `Can be opened by shooting electrical boxes on a weapon with deadwire equipped, whilst riding the inclined lift up from biolabs.` , spoilerTags: `Secret`}),
	...
	[MapIds.citadelle]: [
		new MiscMarker(`7aKbb`, markers.secretArea, [420.6982899821542, 209.87796290629709], { uniqueTitle: `Alchemical Lab`, uniqueDesc: `Walls will open up and reveal this room after activating the PaP machine.` , spoilerTags: `Secret`}),
	...
	[MapIds.tomb]: [
		...
		new MiscMarker(`lCTn_`, markers.tombCrystalStep, [146.84566686502382, 374.5832845750799], { uniqueTitle: `Vermin Crystal`, stepNumber: 5 }),
		...
		new MiscMarker(`e4htw`, markers.tombCrystalStep, [144.37034150436426, 331.0478857343452], { uniqueTitle: `Parasite Crystal`, stepNumber: 7 }),
		...
		new MiscMarker(`mMyTR`, markers.tombCrystalStep, [202.95409409968445, 338.9471435474322], { uniqueTitle: `Doppelghast Crystal`, stepNumber: 9 }),
		...
		new MiscMarker(`cOvgh`, markers.tombCrystalStep, [200.192813907852, 373.4631459453377], { uniqueTitle: `Amalgam Crystal`, stepNumber: 11 }),
	...
	[MapIds.shatteredVeil]: [
		new MiscMarker(`qYnw9`, markers.questCollectible, [328.03120230952925, 459.44431393811743], { uniqueTitle: `Elevator Fuse`, uniqueDesc: `Shoot a zombie body in the library to collect the fuse.` }),
		new MiscMarker(`L_Z5J`, markers.questCollectible, [367.44928155004044, 304.17514880036754], { uniqueTitle: `Elevator Circuit Board`, uniqueDesc: `Shoot Rictofen's computer to eject a circuit board.` }),
		new MiscMarker(`hyuEe`, markers.mainQuest, [354.6147706924116, 356.6210777401763], { stepNumber: 1, uniqueTitle: `Elevator`, uniqueDesc: `Repair the elevator from the back side and use it to reach the mainframe chamber.` }),

		// Obtain Ray Gun Mark 2
		new MiscMarker(`tS3jp`, markers.questCollectible, [405.0232352674998, 177.55817372717638], { uniqueTitle: `Lab Technician Zombie`, uniqueDesc: `Defeat a Lab Technician Zombie in the Service Tunnel or Mainframe Chamber to get a floppy disk.` }),
		new MiscMarker(`uwMYC`, markers.interactable, [307.25707539211015, 406.98788327334006], { stepNumber: 2, uniqueTitle: `Fax Machine`, uniqueDesc: `Insert the floppy disk near the T-Rex skeleton in East Foyer and defend it to print Project Janus paper.` }),
		new MiscMarker(`X0A_C`, markers.clue, [290.22405320470983, 270.62485419854386], { img: `9GkVxOl`, uniqueTitle: `Nursery Room Chalkboard`, uniqueDesc: `Convert the four-letter word into a four-digit code and input it on the keypad in the Service Tunnel.` }),
		new MiscMarker(`ZHWDN`, markers.secretArea, [327.0269772351021, 169.45531025663544], { stepNumber: 3, uniqueTitle: `Service Tunnel Keypad`, uniqueDesc: `Input the code to unlock the glass door, kill the Doppelgast, and retrieve the severed arm.` , spoilerTags: `Secret`}),
		new MiscMarker(`s4lOm`, markers.wonderWeapon, [278.91781207521643, 90.40023948682904], { stepNumber: 4, uniqueTitle: `Raygun Keypad`, uniqueDesc: `Use the severed arm to unlock the Ray Gun Mk2.` }),

		// Collect Upgrade Canisters for Ray Gun Variants
		new MiscMarker(`g1Jjf`, markers.questCollectible, [445.4029481233795, 361.5339699025494], { linkedItems: `qXCsN`, uniqueTitle: `Yellow Mk2 R Canister`, uniqueDesc: `Throw a Kazimir Grenade at a window barrier behind Double Tap to pull in the canister.` }),
		new MiscMarker(`KOsFu`, markers.mainQuest, [202.04146327779557, 227.2595607500608], { stepNumber: 5, uniqueTitle: `Conservatory Charging Spot`, uniqueDesc: `Place the canister, and then plant and charge 4 seeds from the 4 plants around the map (Use explosives on them) to charge the Toxic Canister for Mk2 R.` }),
		new MiscMarker(`2m7Oo`, markers.secretArea, [360.1785531999947, 463.20027135210097], { stepNumber: 6, uniqueTitle: `Yellow Library Liminal Space`, uniqueDesc: `Open the liminal space by interacting with the machine to the left, then kill zombies with the Yellow Mk2 R, talk to ghost Colton, and retrieve blue books on the east side of the map using Aether Shroud.` , spoilerTags: `Secret`}),
		new MiscMarker(`zLikw`, markers.secretArea, [357.71429913925766, 438.9551910771068], { stepNumber: 7, uniqueTitle: `Hidden Vault`, uniqueDesc: `The door to the vault that will open after collecting the 3 blue aether books and activating them in the correct order, indicated by the order of books in the yellow liminal space.` , spoilerTags: `Secret`}),
		new MiscMarker(`Dhelk`, markers.ritualStep, [362.56331519425646, 481.72192284086697], { stepNumber: 8, uniqueTitle: `Yellow Ritual`, uniqueDesc: `After obtaining the Nuclear Plant Inspection Report, return here to start a mini bossfight that requires the Yellow Mk2 R to beat the boss and complete 1 of 3 rituals.` }),

		new MiscMarker(`Pk1Og`, markers.questCollectible, DefaultPOIData.nullLoc, { stepNumber: 9, linkedItems: `x5z67`, uniqueTitle: `Blue Mk2 W Canister`, uniqueDesc: `Break blue crystals/rocks around the map with the Ray Gun Mk2 to retrieve the canister.` }),
		new MiscMarker(`b6R76`, markers.blueCrystal, [183.73476117417513, 168.04033380510796], { uniqueDesc: `Conservatory Roof.` }),
		new MiscMarker(`spNfW`, markers.blueCrystal, [271.75136319063455, 281.25774380888356], { uniqueDesc: `South West Balcony - On the wall.` }),
		new MiscMarker(`PFBY6`, markers.blueCrystal, [299.6148925889505, 410.41339772578345], { uniqueDesc: `East Foyer - Up in the stairwell.` }),
		new MiscMarker(`Vel0p`, markers.blueCrystal, [325.58402024595557, 79.40815081869772], { uniqueDesc: `Service Tunnel Ceiling.` }),
		new MiscMarker(`hktdR`, markers.mainQuest, [88.70836640243886, 289.2664121818658], { stepNumber: 10, uniqueTitle: `Shems Henge Charging Spot`, uniqueDesc: `Place the canister, lure Abominations to charge blue rocks with a beam attack, then have them bash into the rocks with their charge attack. Once the rocks are floating, defend the power siphon from vermin.` }),
		new MiscMarker(`sb2v4`, markers.interactable, [399.3976560096348, 343.6719445224386], { uniqueTitle: `Sconce`, uniqueDesc: `Found in a box in the banquet room, just before getting to the elevator. Used to open the distillery.` }),
		new MiscMarker(`mRA9W`, markers.secretArea, [285.69271819202527, 330.5513293870601], { stepNumber: 11, uniqueTitle: `Hidden Distillery Room`, uniqueDesc: `Use the sconce to start the Simon Says puzzle and access the Distillery.` , spoilerTags: `Secret`}),
		new MiscMarker(`AUQIF`, markers.secretArea, [312.52563158521116, 194.76235011832], { stepNumber: 12, uniqueTitle: `Blue Distillery Liminal Space`, uniqueDesc: `Open the liminal space by interacting with the machine to the left, then kill zombies with the Blue Mk2 W near it, to open it.` , spoilerTags: `Secret`}),
		new MiscMarker(`bDTg6`, markers.interactable, [397.25302768774293, 456.37573054721605], { uniqueTitle: `Service Bell`, uniqueDesc: `Can be found around the study hallway, in a display cabinet, or on a table or the floor. Must be placed at the bar in the grand foyer and rang after brain-rotting a zombie near it.` }),
		new MiscMarker(`YKzSt`, markers.interactable, [251.0527385029055, 386.8629403703979], { stepNumber: 13, uniqueTitle: `Bar`, uniqueDesc: `Where you obtain the Hip Flask, place the service bell and then brain rot a zombie nearby, ring the bell after brain rotting. (Bell can also be rung 115 times to obtain a free perk)` }),
		new MiscMarker(`RoSpw`, markers.ritualStep, [292.437842624879, 177.6072497541765], { stepNumber: 14, uniqueTitle: `Blue Ritual`, uniqueDesc: `After obtaining the Hip Flask, return here to start a mini bossfight that requires the Blue Mk2 W to beat the boss and complete 1 of 3 rituals.` }),

		new MiscMarker(`Kfdhp`, markers.questCollectible, [424.9294165237805, 185.08620216635984], { stepNumber: 14, linkedItems: `L62F6`, uniqueTitle: `Purple Mk2 P Canister`, uniqueDesc: `Use Tomahawks on gas valves and shatter glass chamber with fire/exposives in the Mainframe Chamber to retrieve the canister.` }),
		new MiscMarker(`YHvIl`, markers.interactable, [332.2610008155861, 193.4013839301408], { uniqueTitle: `Gas Valves`, uniqueDesc: `Depending on the letter displayed by the chamber, hit the middle and then corresponding letter valve, with the tomahawks in order to guide the gas to the chamber.` }),
		new MiscMarker(`yb2C7`, markers.questCollectible, [231.15067969531404, 160.4038884122439], { uniqueTitle: `Reflector`, uniqueDesc: `Used in the serpent mount puzzle, found in dried up fountains around the map.` }),
		new MiscMarker(`eanec`, markers.questCollectible, [298.5411880005021, 264.43718585633223], { uniqueTitle: `Reflector`, uniqueDesc: `Used in the serpent mount puzzle, found in dried up fountains around the map.` }),
		new MiscMarker(`GMrCh`, markers.secretArea, [361.0082941825788, 112.5102670478951], { stepNumber: 15, uniqueTitle: `Serpent Mound - Entrance Rubble`, uniqueDesc: `A wall of rubble that must be removed with a yellow bomb that can be found in any of the Project Janus boxes around the map.` , spoilerTags: `Secret`}),
		new MiscMarker(`kcfL2`, markers.mainQuest, [379.3361982537059, 61.94633295843381], { stepNumber: 16, uniqueTitle: `Serpent Mound Charging Spot`, uniqueDesc: `Place the canister, charge it by killing doppleghasts, spawned by solving the reflector puzzle in the room.` }),
		new MiscMarker(`rFYYN`, markers.secretArea, [383.66556318782426, 367.5191027526622], { stepNumber: 17, uniqueTitle: `Banquet Hall Liminal Space`, uniqueDesc: `Open the liminal space by interacting with the machine to the left, then kill zombies with the Purple Mk2 P. Then retrieve the code for the antler carving from the safe in West Hallway by completing the chalice rituals and returning to the area around the elevator.` , spoilerTags: `Secret`}),
		new MiscMarker(`fOhbp`, markers.ritualChalice, [138.93646246666998, 138.57084019702083], { uniqueDesc: `On the stone bench at spawn.` }),
		new MiscMarker(`76wM6`, markers.ritualChalice, [407.27259474191385, 315.77903176077837], { uniqueDesc: `On a table in the wine cellar.` }),
		new MiscMarker(`MVMPK`, markers.ritualChalice, [248.18224910764732, 342.7371515563582], { uniqueDesc: `On a wooden bench above the entrance to the mansion, on the overlook.` }),
		new MiscMarker(`BfrTS`, markers.questCollectible, [375.5052647213617, 333.13776109245003], { stepNumber: 18, uniqueTitle: `Safe`, uniqueDesc: `Contains the Antler Carving, requires the code from the walls after doing the chalice ritual.` }),
		new MiscMarker(`lPUAz`, markers.ritualStep, [383.0239819784801, 380.8853779473328], { stepNumber: 19, uniqueTitle: `Purple Ritual`, uniqueDesc: `After obtaining the Antler Carving, return here to start a mini bossfight that requires the Purple Mk2 P to beat the boss and complete 1 of 3 rituals.` }),
	...
	[MapIds.reckoning]: [
		...
		new MiscMarker('cSsaz', markers.questCollectible, [278.7669564130291, 335.7054937210508], { stepNumber: 1, uniqueTitle: 'Centrifuge Syringe', uniqueDesc: 'Pick up the syringe from the centrifuge in T1 Mutant Research Lab. Required for blood collection.', }),
		new MiscMarker('9C2DV', markers.questCollectible, [406.0784170220409, 422.83458196283834], { stepNumber: 2, uniqueTitle: 'Floating Zombie Blood Sample', uniqueDesc: 'Jump into the Particle Accelerator Beam in T2 Sublevel 10 to knock down the floating zombie, then use the syringe to collect its blood.' }),
		new MiscMarker('dOQMz', markers.questCollectible, [285.63804215388456, 335.9768402052563], { stepNumber: 3, uniqueTitle: 'Fowler Mutant Injection', uniqueDesc: 'Return syringe to centrifuge to spawn a Fowler Mangler. Kill it to obtain the Fowler Mutant Injection.' }),
		new MiscMarker('Y5YcP', markers.questCollectible, [279.54260319694146, 255.49003055639747], { stepNumber: 5, uniqueTitle: 'DNA Vial', uniqueDesc: 'After activating Pack-a-Punch, kill the "Geneticist Zombie" in T1 Mutant Research Lab for a keycard.Use the keycard to open the fridge and collect the DNA Vial. Required for final encounter.', }),
		new MiscMarker('eRGzO', markers.secretArea, [265.7653978967192, 139.23501433123437], { stepNumber: 6, uniqueTitle: 'Bio Scanner Door', uniqueDesc: 'Use the Fowler Mutant Injection at the scanner in T2 Dark Entity Containment to open portal to Teleportation Lab.', spoilerTags: `Secret`}),
		// Step 2: Building Franken-Klaus & Hacking Janus System
		new MiscMarker('zbk_g', markers.questCollectible, [110.80931436710931, 126.58912179280526], { stepNumber: 7, uniqueTitle: 'Klaus Arms', uniqueDesc: '(Location just for reference)\nDuring special rounds, shoot the arms off Kommando Klaus robots. Need 2 arms total.', }),
		new MiscMarker('SDOUT', markers.klausLegs, [64.64678327613858, 136.75281077644698], { stepNumber: 8, uniqueTitle: 'Klaus Legs - Shelf', uniqueDesc: '1 of 4 possible spawn locations for Klaus legs in T2 Android Assembly. On a shelf near the assembly line.', }),
		new MiscMarker('BtK7p', markers.klausLegs, [169.12701996775954, 63.76732070795281], { stepNumber: 8, uniqueTitle: 'Klaus Legs - TV', uniqueDesc: '1 of 4 possible spawn locations for Klaus legs in T2 Android Assembly. Behind the broken TV.', }),
		new MiscMarker('s2_Sp', markers.klausLegs, [156.8331401195596, 128.2240178559916], { stepNumber: 8, uniqueTitle: 'Klaus Legs - Door', uniqueDesc: '1 of 4 possible spawn locations for Klaus legs in T2 Android Assembly. On the ground behind a door.', }),
		new MiscMarker('2ZgTv', markers.klausLegs, [96.07140076681934, 50.1663161262222], { stepNumber: 8, uniqueTitle: 'Klaus Legs - Scrap', uniqueDesc: '1 of 4 possible spawn locations for Klaus legs in T2 Android Assembly. On top of the scrap pile.', }),
		new MiscMarker('peX7s', markers.frankenKlaus, [117.60454468871991, 119.5224838904633], { stepNumber: 9, uniqueTitle: 'Hanging Klaus Assembly', uniqueDesc: 'Place arms and legs on the Hanging Klaus in T2 Android Assembly, then get an Uber Klaus to shock it.', }),
		new MiscMarker('FsyN6', markers.mainQuest, [122.0625, 114.40625], { stepNumber: 10, uniqueTitle: 'Klaus First Terminal', uniqueDesc: 'After activation, Franken-Klaus will work on this terminal. Progress a full round for him to move.', }),
		new MiscMarker('gHBuk', markers.mainQuest, [329.6685873624122, 135.6294188247762], { stepNumber: 11, uniqueTitle: 'S.A.M. Trial - Dark Entity Containment', uniqueDesc: 'Complete the S.A.M. Trial (kill quota) that Klaus activates in T2 Dark Entity Containment.', }),
		new MiscMarker('T2cZG', markers.mainQuest, [206.49762041663564, 128.78930536511223], { stepNumber: 12, uniqueTitle: 'Klaus Final Terminal', uniqueDesc: 'Klaus moves to T2 Teleportation Lab to work on the final terminal. Need 4-digit code to complete.', }),
		// Computer Code Folders (7 possible spawn locations)
		new MiscMarker('Xnrsc', markers.samFile, [416.5697810972365, 207.19992851691046], { stepNumber: 13, uniqueTitle: 'S.A.M File - Executive Suite Table', uniqueDesc: '1 of 7 possible locations for code folders. Check tables in T1 Executive Suite.', }),
		new MiscMarker('ApwQt', markers.samFile, [414.1549057795054, 186.24082121931076], { stepNumber: 13, uniqueTitle: 'S.A.M File - Small Table for Two', uniqueDesc: '1 of 7 possible locations for code folders. On small tables for two in T1 Executive Suite.', }),
		new MiscMarker('IU3cX', markers.samFile, [446.8930789065051, 280.92170759449004], { stepNumber: 13, uniqueTitle: 'S.A.M File - Executive Suite Reception Desk', uniqueDesc: '1 of 7 possible locations for code folders. On the main desk in T1 Executive Suite.', }),
		new MiscMarker('HMx_r', markers.samFile, [467.7513485935004, 272.94344206141733], { stepNumber: 13, uniqueTitle: 'S.A.M File - Directors Office Under TV', uniqueDesc: '1 of 7 possible locations for code folders. Left of lamp under the TV in T1 Directors Office.', }),
		new MiscMarker('br4mJ', markers.samFile, [487.4400877274493, 241.1759933014728], { stepNumber: 13, uniqueTitle: 'S.A.M File - Directors Office Bloody Table', uniqueDesc: '1 of 7 possible locations for code folders. On bloody table in T1 Directors Office.', }),
		new MiscMarker('k0BDe', markers.samFile, [454.36338563691794, 311.8935104795793], { stepNumber: 13, uniqueTitle: 'S.A.M File - Directors Desk', uniqueDesc: '1 of 7 possible locations for code folders. On main desk in T1 Directors Office.', }),
		new MiscMarker('yO_9S', markers.samFile, [218.78011471661623, 117.33172428596046], { stepNumber: 13, uniqueTitle: 'S.A.M File - Teleportation Lab Trolley', uniqueDesc: 'Guaranteed last location for code folders.', }),
		new MiscMarker('7E7uf', markers.mainQuest, [239.57753458119657, 114.99439638079211], { stepNumber: 14, uniqueTitle: 'Computer Terminal', uniqueDesc: 'Input the 4-digit code (arranged chronologically by date) into the computer in T2 Teleportation Lab.', }),
		// Step 3: Obtaining the Gorgofex Wonder Weapon
		new MiscMarker('yKp0H', markers.clue, [285.0283721474805, 221.1873430368458], { stepNumber: 15, uniqueTitle: `Static Screen - Behind Richtofen's Family`, uniqueDesc: `1 of 2 static screens in T1 Mutant Research Lab. Note the first letter of words displayed` }),
		new MiscMarker('vsI0O', markers.clue, [260.2808345369212, 335.0139929537036], { stepNumber: 15, uniqueTitle: 'Static Screen - Left of Deadshot Daiquiri', uniqueDesc: '1 of 2 static screens in T1 Mutant Research Lab. Note the first letter of words displayed' }),
		new MiscMarker('ZewHy', markers.secretArea, [294.9341716881426, 223.53306492051607], { stepNumber: 16, uniqueTitle: 'T1 Bioweapons Lab Access', uniqueDesc: 'Enter periodic element code at keypad to access T1 Bioweapons Lab.', spoilerTags: `Secret`}),
		new MiscMarker('vdjUn', markers.secretArea, [243.14456891269083, 223.53306492051607], { stepNumber: 16, uniqueTitle: 'T1 Bioweapons Lab Access', uniqueDesc: 'Enter periodic element code at keypad to access T1 Bioweapons Lab.', spoilerTags: `Secret`}),
		new MiscMarker('khtv_', markers.wonderWeaponCollectible, [272.27622047388246, 253.99753714137006], { stepNumber: 17, uniqueTitle: 'Gorgofex - Cyst', uniqueDesc: 'Kill 3 Vermin then 3 zombies near the cyst container in T1 Bioweapons Lab to charge it.', }),
		new MiscMarker('ibPbV', markers.aethericFlora, [40.75938916080559, 281.6416383421299], { stepNumber: 18 }),
		new MiscMarker('r_MdI', markers.aethericFlora, [16.1413702684328, 265.0045220019917], { stepNumber: 18 }),
		new MiscMarker('ESbfY', markers.aethericFlora, [89.28833933297638, 242.5291963117688], { stepNumber: 18 }),
		new MiscMarker('QsAqf', markers.wonderWeaponStep, [288.1213288150643, 66.62440463472076], { stepNumber: 19, uniqueTitle: 'Power Surge Computer', uniqueDesc: 'The first of 4 computers with "INITIATE POWER SURGE" text. Activate all 4 in quick succession to trigger the forsaken to spawn an Uber Klaus.', }),
		new MiscMarker('RZ3Fz', markers.wonderWeaponStep, [324.06344184169, 109.18999648468125], { stepNumber: 20, uniqueTitle: 'Forsaken Transfer Panel', uniqueDesc: 'Charged panel in front of Forsaken. Lure weakened Uber Klaus here to start the Forsaken mini-bossfight.', }),
		new MiscMarker('p5vLs', markers.wonderWeapon, [328.2953301886946, 114.39440739753712], { linkedIntelIds: `BO6S5RkAr4`, stepNumber: 21, uniqueTitle: 'Gorgofex', uniqueDesc: 'Defeat The Forsaken, then interact with the remains to form Gorgofex.', }),
		// Step 3.5: Optional Gorgofex Upgrades
		new MiscMarker('BYeNV', markers.gorgofexUpgrade, [151.53604399098379, 482.21800714484493], { stepNumber: 22, uniqueTitle: 'Gorgofex Corpsloder Upgrade Path', uniqueDesc: 'Talk to Blanchard, hit red button in Project Janus Reception, defend Klaus during lockdown.', img: 'MTsrbUs', }),
		new MiscMarker('JFsLj', markers.gorgofexUpgrade, [268.59692944756415, 254.0190771030559], { stepNumber: 22, uniqueTitle: 'Gorgofex Necrodystonia Upgrade Path', uniqueDesc: 'Talk to Blanchard, get Strauss Counter, find Life Drain Serum, collect 3 additional items.', img: 'ekZGOZp', }),
		// Step 4: Unblocking the Portal
		new MiscMarker('ytVc7', markers.mainQuest, [75.3478902393696, 312.00809343738956], { stepNumber: 23, uniqueTitle: 'Project Janus Brain', uniqueDesc: 'Use Melee Macchiato to punch containment chamber in T1 Quantum Computing Core to reveal brain.', }),
		new MiscMarker('t5x4V', markers.interactable, [208.9875590410389, 136.6897795701532], { stepNumber: 24, uniqueTitle: 'Brain Containment Chamber', uniqueDesc: 'Place brain in Project Janus containment chamber in T2 Teleportation Lab (left of Klaus).', }),
		new MiscMarker('zBqlF', markers.questCollectible, [382.28660947433815, 455.9789653258379], { stepNumber: 26, uniqueTitle: 'Boost & Quantum Vermin', uniqueDesc: 'Hit red button on terminal in T2 Sublevel 10 to spawn blue Quantum Vermin. Kill with Gorgofex. Then interact with blue orb to charge the gorgofex.', }),
		new MiscMarker('7RFoK', markers.aetherCrystal, [217.58988167911133, 173.4774343843396], { stepNumber: 27, uniqueTitle: 'Portal Crystals', uniqueDesc: 'Shoot charged Gorgofex at the crystals blocking the portal in T2 Teleportation Lab.', img: `tHfgJfa` }),
		// Step 5: Preparing the Portal
		new MiscMarker('60s9q', markers.mainQuest, [125.53642631075911, 280.9790372828071], { stepNumber: 28, uniqueTitle: 'Fungal Head', uniqueDesc: 'Shoot charged Gorgofex shot at a body hanging from a balcony in Quantum Computing.', img: `YumBytQ`, linkedIntelIds: `BO6S5RkAr3`, }),
		new MiscMarker('O_BUs', markers.interactable, [193.69470763183608, 492.0610615781832], { stepNumber: 29, uniqueTitle: 'Mop Bucket', uniqueDesc: '1 of 2 locations. Move mop bucket under sprinkler, throw explosive at smoke detector to fill.', }),
		new MiscMarker('RBNxh', markers.interactable, [131.02099241020414, 167.61130794894638], { stepNumber: 29, uniqueTitle: 'Mop Bucket', uniqueDesc: '1 of 2 locations. Move mop bucket under sprinkler, throw explosive at smoke detector to fill.', }),
		new MiscMarker('o2IM2', markers.mainQuest, [131.92094905639456, 151.9350571514104], { stepNumber: 30, uniqueTitle: 'Fungal Head Cleaning', uniqueDesc: 'Place Fungal Head in one of the water-filled buckets to clean it, then collect souls by killing zombies.', }),
		new MiscMarker('Zt5sd', markers.interactable, [217.5773258217545, 175.5956543060017], { stepNumber: 31, uniqueTitle: 'Portal Preparation', uniqueDesc: 'Place soul-charged Fungal Head in center of portal in T2 Teleportation Lab.', }),
		// Step 6: Powering the Portal
		new MiscMarker('Y8o2y', markers.questCollectible, [227.4600168565362, 134.7208441861445], { stepNumber: 32, uniqueTitle: 'Vacuum-Seal Device Container', uniqueDesc: 'Blue Project Janus containers now open. Contains Vacuum-Seal Devices for capturing purple items.', img: 'r3phAZ7', }),
		new MiscMarker('QFj29', markers.mainQuest, [218.44700263281527, 148.0822424651694], { stepNumber: 34, uniqueTitle: 'Portal Console', uniqueDesc: 'Insert 4 captured items into console to power it and start a lockdown. There are approximately 10 floating purple objects around the map. Use Vacuum-Seal Devices to capture and return them here.', }),
		new MiscMarker('_r76O', markers.interactable, [228.25063213931875, 163.18299436631585], { stepNumber: 35, uniqueTitle: 'Portal Lockdown Switches', uniqueDesc: '1 of 5 switches in the room that turn red during lockdown. Turn all switches green to complete.', }),
		new MiscMarker('EsUDS', markers.bossFight, [217.34014123691972, 177.3350079281233], { stepNumber: 36, uniqueTitle: 'Portal to Boss Fight', uniqueDesc: 'Interact with portal after completing lockdown to enter final boss encounter area.', }),
	],
	[MapIds.reckoningBossArena]: [
		// Step 7: Final Boss Fight
		new MiscMarker('TLo2x', markers.bossFight, [90.09874392252534, 243.224960481147], { stepNumber: 37, uniqueTitle: 'Floor 1 - Boss Fight Decision', uniqueDesc: 'Make a decision to help SAM or Richtofen.\n\nIf helping Richtofen:\nFight S.A.M (easier)\nTarget weak points after laser attacks and spinning volleys.\n\nIf helping S.A.M:\nFight Uber Richtofen (harder)\nPhase 1: Target shoulders/core.\nPhase 2: Use Aether Shroud.', spoilerTags: `Boss Fight`}),
		new MiscMarker('uPa5O', markers.mainQuest, [55.639174779895285, 302.9950489442297], { stepNumber: 38, uniqueTitle: 'Floor 1 - L.T.G. Canister 1', uniqueDesc: '1 of 3 L.T.G. Canisters in T3 Dark Aether Elements Vault 1. Kill zombies with purple eyes nearby.', }),
		new MiscMarker('xeWFn', markers.mainQuest, [129.71876177255587, 283.28288416506683], { stepNumber: 38, uniqueTitle: 'Floor 1 - L.T.G. Canister 2', uniqueDesc: '1 of 3 L.T.G. Canisters in T3 Dark Aether Elements Vault 1. Kill zombies with purple eyes nearby.', }),
		new MiscMarker('DbRHT', markers.mainQuest, [160.51735719663364, 213.9745895842603], { stepNumber: 38, uniqueTitle: 'Floor 1 - L.T.G. Canister 3', uniqueDesc: '1 of 3 L.T.G. Canisters in T3 Dark Aether Elements Vault 1. Kill zombies with purple eyes nearby.', }),
		new MiscMarker('x89d1', markers.aetherCrystal, [224.60916513815022, 301.90461338621765], { stepNumber: 39, uniqueTitle: 'Floor 2 - Aether Crystals', uniqueDesc: 'Shoot all Aether Crystals in T3 Dark Aether Elements Vault 2 to clear aether flow in pipes.', }),
		new MiscMarker('qkJFg', markers.aetherCrystal, [287.74361523389996, 244.08053759758707], { stepNumber: 39, uniqueTitle: 'Floor 2 - Aether Crystals', uniqueDesc: 'Shoot all Aether Crystals in T3 Dark Aether Elements Vault 2 to clear aether flow in pipes.', }),
		new MiscMarker('Q6sId', markers.bossFight, [90.09874392252534, 243.224960481147], { stepNumber: 40, uniqueTitle: 'Floor 3 - Boss Fight', uniqueDesc: 'You enter the final floor and begin the boss fight. Good luck!', })
	],
};
