...
//     if (x == "Audio Logs") return "intelTypes.audio"
//     if (x == "Radio Transmissions") return "intelTypes.radio"
//     if (x == "Documents") return "intelTypes.docs"
//     if (x == "Artifacts") return "intelTypes.artifact"

//     if (x == "Requiem") return "factions.requiem"
//     if (x == "Omega") return "factions.omega"
//     if (x == "Maxis") return "factions.maxis"
//     if (x == "Dark Aether") return "factions.darkAether"

//     if (x == "Preseason") return "seasons.preseason"
//     if (x == "Season 1") return "seasons.season1"
//     if (x == "Season 2") return "seasons.season2"
//     if (x == "Season 3") return "seasons.season3"
//     if (x == "Season 4") return "seasons.season4"
//     if (x == "Season 5") return "seasons.season5"
//     if (x == "Season 6") return "seasons.season6"

//     if (x == "zoo") return "mapStrings.zoo"
//     if (x == "ruka") return "mapStrings.ruka"
//     if (x == "duga") return "mapStrings.duga"
//     if (x == "alpine") return "mapStrings.alpine"
//     if (x == "golova") return "mapStrings.golova"
//     if (x == "sanatorium") return "mapStrings.sanatorium"
//     if (x == "collateral") return "mapStrings.collateral"
//     if (x == "armada") return "mapStrings.armada"

//     if (x == "outbreak") return "mapStrings.allOutbreakMaps"

//     if (x == "dieMaschine") return "mapStrings.dieMaschine"
//     if (x == "dieMaschine_underground") return "mapStrings.dieMaschineUnderground"
//     if (x == "firebaseZ") return "mapStrings.dieMaschine"
//     if (x == "firebaseZ_spawn") return "mapStrings.firebaseZSpawn"
//     if (x == "mauerDerToten") return "mapStrings.mauerDerToten"
//     if (x == "mauerDerToten_streets") return "mapStrings.mauerDerTotenStreets"

// }
// intelStoreV2.forEach(function(element) {
//     document.getElementById("aside").innerHTML += `
//     {
//         "id": "${element.id}",
//         "faction": "${returnType(element.faction)}",
//         "season": "${returnType(element.season)}",
//         "intelType": "${returnType(element.intelType)}",
//         "loc": "[${((element.loc[0] *2)+512)}, ${((element.loc[1] *2))}]",
//         "map": ${returnType(element.map)},
//         "name": "${element.name}",
//         "desc": "${element.desc}"
//     },
//     `
