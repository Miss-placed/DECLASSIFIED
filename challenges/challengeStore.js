...
class Challenges {
    ...
    static masterChallenges = [
        ...
        new Challenge("uY4dg", challengeTypes.multiplayer, allSubCategories[allCategories.career].fieldSpecialist,
            "Field Specialist Master", "Complete all Field Specialist challenges.", "", ["i7mPR", "vv4HK", "wpkYk", "Lm8tZ", "iTJsw", "AMimD"],
        ),
        new Challenge("fAOoY", challengeTypes.multiplayer, allSubCategories[allCategories.career].eliteOperator,
            "Elite Operator Master", "Complete all Elite Operator challenges.", "", ["XZSFo", "3G0gq", "ZRBLA", "RSmdU", "gHeI7", "Bbnwq"],
        ),
        new Challenge("F1dFE", challengeTypes.multiplayer, allSubCategories[allCategories.career].counterMeasures,
            "Counter Measures Master", "Complete all Counter Measures challenges.", "", ["rvcLo", "cYzZT", "UFu1X", "Qr836", "2ObJV", "Qk_tA"],
        ),
        new Challenge("hCcbo", challengeTypes.multiplayer, allSubCategories[allCategories.career].grizzledVeteran,
            "Grizzled Veteran Master", "Complete all Grizzled Veteran challenges.", "", ["hldBh", "OYu0L", "zDjPq", "m4XcI", "z3cyt", "7Xj_J"],
        ),
        new Challenge("tY8y5", challengeTypes.multiplayer, allSubCategories[allCategories.battleHardened].killer,
            "Killer Master", "Complete all Killer challenges.", "", ["_pGlM", "mojKO", "7Y0mg", "gGduq", "9BrbH", "3Hpui"],
        ),
        new Challenge("Z470J", challengeTypes.multiplayer, allSubCategories[allCategories.battleHardened].goingHam,
            "Going Ham Master", "Complete all Going Ham challenges.", "", ["JT0iE", "KHjkl", "2eIoH", "bUO0i", "OEr7c", "KI79l"],
        ),
        new Challenge("MNPTu", challengeTypes.multiplayer, allSubCategories[allCategories.battleHardened].humiliation,
            "Humiliation Master", "Complete all Humiliation challenges.", "", ["1DphZ", "TgT9A", "WRYbH", "zLZkp", "T3N0y", "83j0u"],
        ),
        new Challenge("0gsUh", challengeTypes.multiplayer, allSubCategories[allCategories.battleHardened].precision,
            "Precision Master", "Complete all Precision challenges.", "", ["I6GTY", "_sI8K", "7zDOO", "pIl7r", "5ZDZi", "E4yaB"],
        ),
        new Challenge("qYo97", challengeTypes.multiplayer, allSubCategories[allCategories.battleHardened].returnFire,
            "Return Fire Master", "Complete all Return Fire challenges.", "", ["quncz", "aohni", "y0mbJ", "FFEzW", "WTUOL", "bPpLH"],
        ),
        new Challenge("ycxYB", challengeTypes.multiplayer, allCategories.darkOps,
            "Dark Ops Master", "Complete all Dark Ops Challenges.", "", ["U2K38", "cJPcg", "bllEj", "kq8p7", "gU1OD", "0OuTg", "OMPEs", "ZTRjf", "uTL8M", "d6aqJ", "zMGwC", "RkjEN", "3gvu4"],
        ),
        new Challenge("_PivS", challengeTypes.multiplayer, allSubCategories[allCategories.seasonal].season1,
            "Season One Master", "Complete all Season One Challenges.", "", ["YiClE", "QuLbY", "Kk2zJ", "TS_UL", "Hg3Ur", "vnz5a", "z5uxh", "hyB8L", "qNwON", "W_fz8", "iHSka", "LLozr", "Me6QD", "IFnBC", "7J3lG", "fteHv", "Thdgo", "c0bSG", "wxZtr", "xvvtz"],
        ),
        new Challenge("i53_h", challengeTypes.multiplayer, allSubCategories[allCategories.seasonal].season2,
            "Season Two Master", "Complete all Season Two Challenges.", "", ["gI_5g", "l9xby", "4Uv2s", "wxqrQ", "kICbI", "x8tMD", "epAHP", "6jBer", "C7DPO", "wOs6N", "LWDKz", "x4s5w", "cWjZx", "gqZZX", "AnSbY", "yxcnt", "YPQWg", "foCEu", "4u3jF", "i7Shn"],
        ),
        new Challenge("UTxmG", challengeTypes.multiplayer, allSubCategories[allCategories.seasonal].season3,
            "Season Three Master", "Complete all Season Three Challenges.", "", ["dnFY0", "xwmbM", "O_FWS", "yzXU9", "nipMJ", "socRp", "0xKhr", "PIQ9w", "DE9JU", "vJkOD", "SzgHZ", "VrJfI", "HwmK5", "gcdht", "Hts55", "oys8K", "3rRsf", "As8Qx", "cb8IC", "bkLGd"],
        ),
        new Challenge("UtYbw", challengeTypes.multiplayer, allSubCategories[allCategories.seasonal].season4,
            "Season Four Master", "Complete all Season Four Challenges.", "", ["hUSHW", "5Jw1h", "dv_h7", "sRt5A", "ieAF6", "InVpN", "0nT1k", "ZHT7n", "dfIY2", "9vTx9", "T2Dg6", "lHbhl", "ki9UK", "ghZZ9", "bhTNj", "bk4_p", "VF7J0", "1geyt", "siIK1", "z4kiK"],
        ),
        new Challenge("sDepO", challengeTypes.multiplayer, allSubCategories[allCategories.seasonal].season5,
            "Season Five Master", "Complete all Season Five Challenges.", "", ["TZGtK", "gWuEs", "gmyUp", "QeWHq", "7Bfx9", "SKnXo", "oN3pT", "NBt6Y", "Fen_N", "qny36", "wAq2z", "GBA19", "p9wWY", "bNpYx", "kPOoc", "GluMr", "6v5pK", "DTFar", "uiKcs", "yTxI4"],
        ),
        new Challenge("Dtui7", challengeTypes.multiplayer, allSubCategories[allCategories.seasonal].season6,
            "Season Six Master", "Complete all Season Six Challenges.", "", ["4CijS", "uMYqf", "8ROcH", "yglFa", "IBwIq", "XrR0U", "0sIw2", "8wQ68", "g9_Xe", "QRIMI", "iT_K2", "jhHcO", "hGNw3", "3fd0n", "wndQr", "F933z", "OkPbi", "jtfN9", "Erluw", "6BRQ6"],
        ),
        //#endregion Multiplayer
