...
class Challenges {
    ...
    static masterChallenges = [
        ...
        new Challenge("4gt3e", challengeTypes.zombies, allSubCategories[allCategories.seasonal].season1,
            "Season One Master", "Complete all Season One Challenges.", "", ["ZhUlw", "QDNyq", "djKEm", "GjT8r", "aYMLN", "qzyiR", "Gz9fc", "PVhOc", "8CHPN", "95qXU", "NwmOh", "0d2rS", "1PE3z", "UffdG", "qUnDP", "5P4CK", "uBiJo", "LPj0X", "fKo1t", "dy1dd"],
        ),
        new Challenge("4_kRi", challengeTypes.zombies, allSubCategories[allCategories.seasonal].season2,
            "Season Two Master", "Complete all Season Two Challenges.", "", ["neUpQ", "xqrnT", "wGAcn", "yuI6t", "JoCDN", "N2dD9", "PhfqK", "cVCfB", "h2xmg", "mgzlO", "OJPD3", "Wcrz0", "tMaio", "ORmsi", "tlvNT", "Qkf3K", "q2Pu8", "6DfWd", "9EMSp", "a3sXk"],
        ),
        new Challenge("wFfVg", challengeTypes.zombies, allSubCategories[allCategories.seasonal].season3,
            "Season Three Master", "Complete all Season Three Challenges.", "", ["RwUEL", "WzbjY", "nRuv3", "Vjncb", "6TAPg", "AU1Ij", "RfKAI", "yAbEy", "zczyD", "CsPTc", "RwiPF", "XMXBC", "HNVOO", "E5uub", "I3e70", "FUQGR", "SrZFc", "R2Wmq", "qBEsA", "sdHFl"],
        ),
        new Challenge("t26F_", challengeTypes.zombies, allSubCategories[allCategories.seasonal].season4,
            "Season Four Master", "Complete all Season Four Challenges.", "", ["46hVl", "UfO01", "sMNem", "CNS24", "9tGW2", "l3dmG", "bY6l8", "mCthD", "heAsr", "nstYT", "5akvf", "1BLOi", "OyBae", "YIdVg", "EMdrj", "KcMXP", "a4LeH", "qbQrK", "r855I", "Sge6y"],
        ),
        new Challenge("3Iszp", challengeTypes.zombies, allSubCategories[allCategories.seasonal].season5,
            "Season Five Master", "Complete all Season Five Challenges.", "", ["HQBWK", "uo1Se", "nz4d6", "C3hjf", "RYOo6", "A3ACV", "Ehxle", "nCyRB", "rDkxJ", "mGkbB", "O_mR4", "RJbSw", "0bbhY", "Dsj47", "yqBkz", "g4bLm", "c7XbO", "DvrL1", "aEUIH", "3G1jK"],
        ),
        new Challenge("7TIfX", challengeTypes.zombies, allSubCategories[allCategories.seasonal].season6,
            "Season Six Master", "Complete all Season Six Challenges.", "", ["ZOTqv", "iKo1Y", "mk27c", "ZmeoD", "nTd8p", "ehJYv", "ED0d1", "jcZeL", "zkrCw", "KH0wR", "YaRNh", "u3UoT", "Aey1V", "JohuP", "tHSiu", "xGS5U", "T_g0G", "kksnF", "MX6Tz", "ktU6O"],
        ),
        //#endregion Zombies
